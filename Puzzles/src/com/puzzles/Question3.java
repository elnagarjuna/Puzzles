...
public class Question3 {
	...
	public static void main(String[] args) throws IOException {
		...
		if (adventurerSteps <= monsterSteps) {
			...
			System.out.print("Path : (" + adventurerPosition[0] + ", " + adventurerPosition[1] + ")->");
			while (adventurerPosition[1] < goldPosition[1]) {
				adventurerPosition[1]++;
				System.out.print("(" + adventurerPosition[0] + ", " + adventurerPosition[1] + ")->");
			}
			while (adventurerPosition[1] > goldPosition[1]) {
				adventurerPosition[1]--;
				System.out.print("(" + adventurerPosition[0] + ", " + adventurerPosition[1] + ")->");
			}
			while (adventurerPosition[0] < goldPosition[0]) {
